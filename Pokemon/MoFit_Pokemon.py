...
def main_adv_text_per_img_10(args):
    ...
    if args.mem == "member":
        caption_path = "/home/test/MoFit/data/Captions/Pokemon/ClipInterrogator_Pokemon_members_captions.jsonl"

    elif args.mem == "non_member":
        caption_path = "/home/test/MoFit/data/Captions/Pokemon/ClipInterrogator_Pokemon_non_members_captions.jsonl"
    ...
    ## **** ##
    npy_path = "/home/test/MoFit/data/rnd_noise_1.npy"
    ...
    for j in range(anchor, until, -1):
        ...
        for it in pbar_adv:
            ...
            _, _, noise_pred_uncond, noise_pred_text = pipe.mtcnp_adv(perturb_embeds=None, perturb_latent=adv_latent_xt, prompt=pred_prompt, anchor=t, guidance_scale=7.5) 
